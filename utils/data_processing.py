...
def get_data_node_classification(dataset_name, use_validation=False):
  ...
  graph_df = pd.read_csv(root+'tgn/data/ml_{}.csv'.format(dataset_name))
  edge_features = np.load(root+'tgn/data/ml_{}.npy'.format(dataset_name))
  node_features = np.load(root+'tgn/data/ml_{}_node.npy'.format(dataset_name))
