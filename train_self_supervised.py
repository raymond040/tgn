...
if hpc_stat == 1:
  ...
  MODEL_SAVE_PATH = f'/home/svu/e0407728/My_FYP/tgn/saved_models/{args.prefix}-{args.data}.pth'
  get_checkpoint_path = lambda \
      epoch: f'/home/svu/e0407728/My_FYP/tgn/saved_checkpoints/{args.prefix}-{args.data}-{epoch}.pth'

  ### set up logger
  logging.basicConfig(level=logging.INFO)
  logger = logging.getLogger()
  logger.setLevel(logging.DEBUG)
  Path("/home/svu/e0407728/My_FYP/tgn/log/").mkdir(parents=True, exist_ok=True)
  ...
  for i in range(args.n_runs):
    results_path = "/home/svu/e0407728/My_FYP/tgn/results/{}_{}.pkl".format(args.prefix, i) if i > 0 else "/home/svu/e0407728/My_FYP/tgn/results/{}.pkl".format(args.prefix)
